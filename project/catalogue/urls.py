...
from .views import (ProjectsByLanguage, ProjectsByTechnology, ProjectsByFeature,
                    ...
                    AboutView, LinkByTypeView, LinkAdd, LinkDelete, LinksView)
...
urlpatterns = [
    ...
    path('add/link', LinkAdd.as_view(), name='add_link'),
    ...
    path('delete/link/<int:pk>', LinkDelete.as_view(), name='delete_link'),
    ...
    path('links/<str:type>', LinkByTypeView.as_view(), name='link_by_type'),
